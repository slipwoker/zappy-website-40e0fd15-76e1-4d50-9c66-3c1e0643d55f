    ...
    if (contactForm) {
        ...
        const validators = {
            ...
            phone: function(value) {
                ...
                if (!phoneRegex.test(value.trim())) return 'يرجى إدخال رقم هاتف صحيح';
                return null;
            },
            message: function(value) {
                if (!value || value.trim() === '') return 'الرسالة مطلوبة';
                if (value.trim().length < 10) return 'الرسالة يجب أن تكون 10 أحرف على الأقل';
                return null;
            }
        };
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '40e0fd15-76e1-4d50-9c66-3c1e0643d55f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '40e0fd15-76e1-4d50-9c66-3c1e0643d55f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '40e0fd15-76e1-4d50-9c66-3c1e0643d55f';
